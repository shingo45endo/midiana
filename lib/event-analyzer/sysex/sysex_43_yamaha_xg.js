...
const modelProps = [
	...
	// [1998-05-22 (Ver.1.0)] Yamaha MU128 (Tone Generator)
	// [1998-06-01 (Ver.1.0)] Yamaha SW1000XG (PCI Audio MIDI Card)
	...
	// [1997-04-14 (Ver.1.0)] Yamaha PSR-B50 (Portable Keyboard)
	...
	// [2010-09-10 (Ver.1.00)] Yamaha PSR-A2000 (Digital Keyboard)
	// [2020-09-13 (Ver.1.0)] Yamaha PSR-S650 (Digital Keyboard)
	...
	// [2024-05-01 (Ver.1.0)] Yamaha PSR-SX920 (Digital Keyboard)
	// [2024-05-01 (Ver.1.0)] Yamaha PSR-SX720+ (Digital Keyboard)
	// [2024-05-01 (Ver.1.0)] Yamaha PSR-SX720 (Digital Keyboard)
	...
	// [2009-12-01 (Ver.1.0)] Yamaha YPT-420 (Digital Keyboard) [XGlite]
	// [2010-02-04 (Ver.1.0)] Yamaha KBP-500/300, KB-281/280/180, SKB-180 (Digital Piano / Digital Keyboard) [XGlite]
	// [2010-08-26 (Ver.1.0)] Yamaha PSR-E333, YPT-330 (Portatone) [XGlite]
	// [2010-08-26 (Ver.1.0)] Yamaha PSR-E233, YPT-230 (Portatone) [XGlite]
	// [2011-12-28 (Ver.1.0)] Yamaha PSR-E433 (Portatone) [XGlite]
	// [2011-12-28 (Ver.1.0)] Yamaha PSR-I455 (Digital Keyboard) [XGlite]
	// [2011-12-28 (Ver.1.0)] Yamaha KB-291/290/191/190 (Digital Keyboard) [XGlite]
	// [2012-02-20 (Ver.1.0)] Yamaha EZ-220 (Digital Keyboard) [XGlite]
	// [2012-02-20 (Ver.1.0)] Yamaha EZ-J220 (Digital Keyboard) [XGlite]
	// [2012-06-28 (Ver.1.0)] Yamaha PSR-E344 (Portatone) [XGlite]
	// [2012-06-28 (Ver.1.0)] Yamaha PSR-E343, YPT-340 (Digital Keyboard) [XGlite]
	// [2012-06-28 (Ver.1.0)] Yamaha PSR-E244 (Portatone) [XGlite]
	// [2012-06-28 (Ver.1.0)] Yamaha PSR-E243, YPT-240 (Digital Keyboard) [XGlite]
	// [2013-02-09 (Ver.1.0)] Yamaha PSR-E443 (Portatone) [XGlite]
	// [2014-09-29 (Ver.1.0)] Yamaha PSR-E353 (Portatone) [XGlite]
	// [2015-09-17 (Ver.1.0)] Yamaha PSR-E453/EW400 (Portatone) [XGlite]
	...
	// [2020-02-26 (Ver.1.0)] Yamaha EZ-300 (Portable Keyboard) [XGlite]
	// [2021-09-26 (Ver.1.0)] Yamaha PSR-I300 (Portable Keyboard) [XGlite]
	// [2021-10-10 (Ver.1.0)] Yamaha PSR-E473/EW425 (Portable Keyboard) [XGlite]
	// [2022-12-16 (Ver.1.0)] Yamaha PSR-I500 (Portable Keyboard) [XGlite]
	// [2022-12-16 (Ver.1.0)] Yamaha PSR-I400 (Portable Keyboard) [XGlite]
	// [2024-05-02 (Ver.1.0)] Yamaha PSR-E383/EW320, EZ-310, YPT-W320 (Portable Keyboard) [XGlite]
	// [2025-05-14 (Ver.1.0)] Yamaha PSR-E583/E483 (Digital Keyboard) [XGlite]
	// [2025-05-14 (Ver.1.0)] Yamaha PSR-I610/I510 (Digital Keyboard) [XGlite]
	...
	// [2025-11-30 (Ver.1.00)] Yamaha ELS-03XF/XR/X/G (Electone)
	...
	// [2023-08-01 (Ver.1.00)] Yamaha SEK-300 (School Educational Keyboard) [XGlite]
	{
		modelName: 'XG',
	...
	},
	{
		...
		modelId: [0x4c], commands: [0x00, 0x10, 0x20, 0x30],
		address: [
			'10 0[0-9a-d] (?:0[0-4be]|1[1-4]|3[2359ab]|40|59|60)',  // A/D Part 1-14
			'11 0[0-9a-d] 0[0-3]',                                  // A/D Configuration 1-14
			'12 0[0-9a-d] 10',                                      // A/D Part (additional) 1-14
		],
	},
	{
		modelName: 'MU1000',
...
function makeYamahaXgParser(modelProp) {
	const {modelName, modelId, subModelId, address} = modelProp;
	...
	for (const commandId of modelProp.commands) {
		...
		switch (commandId) {
		case 0x00: // Bulk Dump
			regexp = new RegExp(String.raw`^f0 ${mfrIdHex} ${commandReStr} ${modelIdHex} .. ..${(subModelIdHex) ? ` ${subModelIdHex}` : ''} ${addrReStr} (?:.. )+.. f7$`, 'u');
			handler = ((modelId, modelIdHex, subModelId, subModelIdHex, modelName, commandName) => {
				...
				return (bytes) => {
					...
					const requiredSize = as14bitBE(...bytes.slice(index, index + 2));
					index += 2;
					...
					return {
						mfrId, deviceId, modelId, modelIdHex, ...subModelObj, modelName, commandId, commandName, address, requiredSize, rawValues, checkSum, expectedCheckSum, isCheckSumError,
		...
		case 0x10: // Parameter Change
			...
			handler = ((modelId, modelIdHex, subModelId, subModelIdHex, modelName, commandName) => {
				...
				return (bytes) => {
					...
					return {
						mfrId, deviceId, modelId, ...subModelObj, modelName, commandId, commandName, address, rawValues,
						_idKey: idKey, _paramKeys: ['address'], _valueKeys: ['rawValues'],
					};
				};
			})(modelId, modelIdHex, subModelId, subModelIdHex, modelName, commandNames[commandId]);
		...
		case 0x30: // Parameter Request
			regexp = new RegExp(String.raw`^f0 ${mfrIdHex} ${commandReStr} ${modelIdHex}${(subModelIdHex) ? ` ${subModelIdHex}` : ''} .. .. .. f7$`, 'u');
			handler = ((modelId, modelIdHex, subModelId, subModelIdHex, modelName, commandName) => {
				...
				return (bytes) => {
					...
					return {
						mfrId, deviceId, modelId, ...subModelObj, modelName, commandId, commandName, address,
