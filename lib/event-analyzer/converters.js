...
export const converters = Object.freeze({
	...
	'28bitBE':        makeConverter(7, 4, false),
	'35bitBE':        makeConverter(7, 5, false),
	'14bitLE':        makeConverter(7, 2, true),
	'21bitLE':        makeConverter(7, 3, true),
	'28bitLE':        makeConverter(7, 4, true),
	'35bitLE':        makeConverter(7, 5, true),
});
...
export const {makeValue: as28bitBE,        makeArray: convert28bitBE}        = converters['28bitBE'];
export const {makeValue: as35bitBE,        makeArray: convert35bitBE}        = converters['35bitBE'];
...
export const {makeValue: as28bitLE,        makeArray: convert28bitLE}        = converters['28bitLE'];
export const {makeValue: as35bitLE,        makeArray: convert35bitLE}        = converters['35bitLE'];
