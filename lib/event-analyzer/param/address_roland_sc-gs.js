...
import jsonGs from './address_41_42_gs.json' with {type: 'json'};
import jsonLcd from './address_41_45_sc-lcd.json' with {type: 'json'};
//import jsonDevice from './address_41_45_sc-device.json' with {type: 'json'};
